  ...
  function drawMultSeries() {
      ...
      data.addRows([
        ...
        [{v: [<?php echo str_replace(":",",",$novo[$i]['calldate']) ?>], f: '<?php $nl = explode(":",$novo[$i]['calldate']); echo $nl[0]."h"?>'},
            <?php $n1=$novo[$i]['numero_de_ligacoes']; if($n1==0)$n1="0.1"; echo $n1 ?>,
            <?php $n2=$novoArrayCRM[$i]['numero_de_ligacoes'];if($n2==0)$n2="0.1"; echo $n2 ?>,
            <?php $n2=$novoArrayCRM_N_R[$i]['numero_de_ligacoes'];if($n2==0)$n2="0.1"; echo $n2 ?>,
            <?php $n2=$novoArrayCRM_Reagendadas[$i]['numero_de_ligacoes'];if($n2==0)$n2="0.1"; echo $n2 ?>
        ],
